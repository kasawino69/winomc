...
**WinoMC** bringt Minecraft Bedrock als Home-Assistant-Add-on auf dein System.
...
WinoMC richtet sich an alle, die einen Minecraft Bedrock Server bequem zu Hause betreiben möchten, ohne dafür ständig per SSH, Terminal oder Dateifreigaben arbeiten zu müssen.

---

## Was ist WinoMC?

WinoMC ist ein Home-Assistant-Add-on-Repository für Minecraft Bedrock.
...
WinoMC ist dabei mehr als nur ein Startscript für den Server.  
...
WinoMC wurde mit einem klaren Ziel entwickelt:

> Minecraft Bedrock Server sollen sich in Home Assistant einfach, sicher und angenehm bedienen lassen.

Viele Serverlösungen funktionieren technisch, fühlen sich aber im Alltag oft wie reine Admin-Werkzeuge an. WinoMC versucht, daraus ein nutzbares Produkt zu machen:
...
WinoMC enthält eine eigene Weboberfläche in Home Assistant.
...
WinoMC unterstützt typische Minecraft-Bedrock-Dateien:
...
Für Sicherheit im Alltag setzt WinoMC auf:
...
## Für wen ist WinoMC gedacht?

WinoMC passt besonders gut für:
...
Das Haupt-Add-on bleibt der WinoMC Bedrock Server.
...
Danach das gewünschte WinoMC Add-on installieren.
...
WinoMC-spezifische Anpassungen, Weboberfläche, UX, Add-on-Integration und Weiterentwicklung werden im WinoMC-Projekt gepflegt.
